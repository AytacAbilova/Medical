    ...
    <main className="bg-white">
      ...
      <section className="bg-[#F8F9FB] pt-16 pb-12">
        <div className="max-w-[900px] mx-auto px-6">
          ...
          <p className="text-[#465271] text-[16px] mt-4 leading-relaxed">
            {service.desc}
          </p>
        </div>
      </section>
          ...
          {service.sections.map((section, i) => (
            ...
            >
              <h2 className="text-[#001a56] font-extrabold text-[18px] mb-4 flex items-center gap-2">
                <span className="w-1.5 h-5 bg-[#2388ff] rounded-full inline-block shrink-0" />
                {section.title}
              </h2>
